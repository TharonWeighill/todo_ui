    ...
    render() {
        return (
            <ul className="navMenu">
                ...
                <a href='http://localhost:9011/oauth2/authorize?client_id=a7f398aa-8337-4112-94a0-f99bc29a8136&response_type=code&redirect_uri=http://localhost:3000'>Login</a>
